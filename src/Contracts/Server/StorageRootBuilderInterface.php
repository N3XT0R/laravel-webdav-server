...
interface StorageRootBuilderInterface
{
     ...
     * @param  WebDavStorageSpaceValueObject  $space  Resolved storage space containing target disk and user-scoped root path.
     * @return StorageRootCollection Root SabreDAV collection used as the server tree root.
     */
